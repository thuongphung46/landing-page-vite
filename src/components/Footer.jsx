      ...
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0">
        <div className="col-span-2">
          ...
          <h3 className="py-2 text-[#6D737A]">
            Địa chỉ: Nhà 6B - T6, Tòa Nhà hỗn hợp Sông Đà, Số 131 Đường Trần
            Phú, P. Văn Quán, Q. Hà Đông, TP. Hà Nội
          </h3>
        ...
        <div>
          <h3 className="text-xl font-bold whitespace-nowrap">CHÍNH SÁCH CHUNG</h3>
        ...
        <div className="max-[780px]:col-span-2">
          <h3 className="text-xl font-bold whitespace-nowrap">TƯ VẤN MUA HÀNG MIỄN PHÍ</h3>
          <form className="py-4">
            <input
