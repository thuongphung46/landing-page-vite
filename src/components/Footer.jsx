    ...
    <div id="footer" className="w-full bg-white py-24">
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0">
        <div className="col-span-2">
          <div className="flex items-stretch"><img
            src={
              "https://w.ladicdn.com/s350x350/5e476fd054f5fa0a4cfbc867/rbg/0001-3-1024x869-20230202071135--u5sn.png"
            }
            className="h-14"
          />
          <p className="flex text-center text-xl">Công ty TNHH OTD Việt Nam</p></div>
          ...
          Địa chỉ: Nhà 6B - T6, Tòa Nhà hỗn hợp Sông Đà,
Số 131 Đường Trần Phú, P. Văn Quán, Q. Hà Đông, TP. Hà Nội
          </h3>
        ...
        <div>
          <h3 className="text-2xl font-bold">CHÍNH SÁCH CHUNG</h3>
          <ul className="py-6 text-[#6D737A]">
            <li className="py-2">Chính sách mua hàng</li>
            <li className="py-2">Chính sách vận chuyển</li>
            <li className="py-2">Chính sách thanh toán</li>
          </ul>
        </div>
